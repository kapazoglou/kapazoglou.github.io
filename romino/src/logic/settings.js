...
export const SETTINGS_CONFIG = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'dominoSpots',         label: 'Domino spots',              default: true, type: 'toggle' },
      { key: 'starPowers',          label: 'Star Powers',             default: true, type: 'toggle' },
      { key: 'pushBelowCost',       label: 'Bugger',                  default: 1, type: 'stepper', min: 0, max: 5 },
      { key: 'buggerSingles',       label: 'Bugger Singles',          default: true, type: 'toggle' },
