...
- `toggleDominoSpotsVisibility()` / `syncDominoSpotsVisibility()` — deck badge tap hides/shows seam domino glyphs; nRoll>1 discard pile follows (`--spots-suppressed`); nRoll=1 hand exempt
