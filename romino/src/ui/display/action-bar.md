...
v: 1.53
date: 2026-08-03
deps: [state, cards, dice, grid, end-game-prompt, domino-roll]
---
...
- **Domino Roll nRoll=4** — dual-pair tray (pipe separator + deck counter beneath; fixed slots; toward-`|` on drag/placement; return order preserved per pair)
