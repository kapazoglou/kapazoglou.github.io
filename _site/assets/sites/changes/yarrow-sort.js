...
if(LineValue == 6) bottom.push('6');
if(LineValue == 7) bottom.push('7');
if(LineValue == 8) bottom.push('8');
if(LineValue == 9) bottom.push('9');
  
console.log( '6:' + bottom.filter( val => val == 6).length * / 1 );
console.log( '7:' + bottom.filter( val => val == 7).length * / 5 );
console.log( '8:' + bottom.filter( val => val == 8).length * / 7 );
console.log( '9:' + bottom.filter( val => val == 9).length * / 3 );
