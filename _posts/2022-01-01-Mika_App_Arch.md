...
image: "/assets/images/item/MK-101.png"

---

> Redesigned Mika Health's entire app flow from the ground up: removing dead ends; creating a purposeful retention loop; and introducing personalisation for cancer patients. Wireframes tested well; MVP commissioned.
...
{% comment %} Replace preview PNG: post-mika-app-arch-selection-10-6593.svg · label→ Open Figma: project selection {% endcomment %}
{% include figma-embed-overlay.html embed_url="https://embed.figma.com/design/1N5pVskSwQNYdU1aQlZN7y/Project-Selection?node-id=10-6593&embed-host=share" preview_src="/assets/images/figma-previews/post-mika-app-arch-selection-10-6593.png" label="Open Figma: project selection" %}
...
{% comment %} Replace preview PNG: post-mika-app-arch-selection-4-6589.svg · label→ Open Figma: project selection (second embed) {% endcomment %}
{% include figma-embed-overlay.html embed_url="https://embed.figma.com/design/1N5pVskSwQNYdU1aQlZN7y/Project-Selection?node-id=4-6589&embed-host=share" preview_src="/assets/images/figma-previews/post-mika-app-arch-selection-4-6589.png" label="Open Figma: project selection" %}
