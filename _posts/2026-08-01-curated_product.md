...
> *Please allow a few seconds for each embedded Figma project to load. I am aware it is not the optimal user experience but I also find it to be a straightforard way to share Figma files. You can view them in full-screen by clicking the button on the top-right of each frame. 
